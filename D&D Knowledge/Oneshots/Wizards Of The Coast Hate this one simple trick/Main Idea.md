There are three local wizards in a coastal city that are trying to repair their connection to the main hub. They are pretty chill about it. 
There are three wizards, each with different personalities, and they have hired the party to defend the portal, in case something bad comes out.

The wizards show the party some routes that they can get through that they will need to do in order to fix their portal

A map of these routes can be seen at [[The Map]]

Some ideas for what's happening along the way
Some random events that can happen on each spot of the map too maybe. Nah, let's have them all pre-planned

- Combat Encounters:
	- # The Angry Gorillas:
		- The party is taken to a primordial jungle where they are surrounded by a bunch of monkey like creatures, that attack the party. They can be warded off. This can lead to [[#The Happy Gorillas]].
	- # The Wizard War:
		- The party arrives at a wizard war, in the middle of the whole field, with a group of wizards approaching, and they have to fend these wizards off. Thank god they are underleved and know few spells, but they have some cooler spells, like mend buttcrack. 
	- # The Hell:
		- A hellscape all around them. with several demons flying over head them, and there being two or three spectators that engage with the party in combat, telling them "YOU ARE NOT SUPPOSED TO BE HERE!"
	- # Under The Sea:
...
- Roleplay Encounters:
	...
	- # OBJECTIVE: KILL GOD
		- In the sky, there is a cloud, that the party starts on. On the other side of them, there is a massive wall, like massive, as far as the eye can see wall, on which a massive skull is embedded into the wall, and a message in blood, that says: "Objective: KILL GOD" and massive echoes of footsteps can be heard in the distance on the other side of them. The skull is of a tarrasque. 
- Trap Encounters:
	- # The Void:
	...
	- # Icy Caverns:
		- The party spawns in an ice caverns, where the temperature is freezing, and they need to light a fireplace, or keep it warm while the wizards make the portal thingy. They must roll a DC 12 con save every minute, and it increases by 1 for every time, or take 1d8 cold damage
- Removed Encounters:
	- # Passage Below:
