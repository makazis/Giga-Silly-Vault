...
File: Theory D&D\Theories\Spiritual\1800s Technology.md
...
#Magic #Thing 
An enchantment is a long lasting [[Magic]]al effect, that affects a body, entity, or something else. 
...
#Thing 
A group of [[Tree]]s. 
Has a [[Hivemind]], and stores some [[Magic]]al energy and [[Mana]] in them because of that. [[Human]]s staying here for extended periods of time begin to [[Decalcification|Decalcify]] their body, and become more susceptible to the [[Spiritual Plane]], letting them attain the ability to use magic. 
...
Historical figures have been drinking from the grail for centuries, staying eternally young, and influening secret societies, meaning that one secret society has the grail in their posession, which is how they are still alive (probably vatican tbh)
...
- There is a teaching within the illuminati, that teaches the user about a specific pattern, used in the incorruptible [[Saint]]s, that allows them to become one after [[Death]]. After that, they forge a deal, that their [[Soul]] will join an universal veil between the illuminati and the outside world, storing their memories, and upkeeping knowledge, as well as giving the cult members access to [[Magic]]. This also turns some of the cult members into [[Pattern Manipulator]]s. 
...
File: Theory D&D\Things\Magic\Primal Spells\Imbue Mana.md
...
#Magic #Ritual 
- Description:
	- A [[Ritual]] that increases the tier of a [[Magic]] item, allowing you to store more enchantments on it. Has different costs for each tier, getting only more expensive the more enchantments are stacked on the item. 
...
The type of cleaning depends on the essence of the thing that you swallow, and the strongest essence of them all is a [[Soul]], so humans, and especially humans with [[Magic]]al capabilities are more potent in these sorts of rituals.
...
File: Theory D&D\Theories\Spiritual\Robert Golf Glass Camera.md
...
This is done by [[Magic]] or a [[Ritual]].
...
File: Theory D&D\Concepts\Science\The Natural Forces.md
...
These are a seperate set, similar to those of [[The Elements]] 
...
File: Theory D&D\Concepts\Science\Time.md
...
File: Theory D&D\Theories\Spiritual\Trees are Mammals.md
...
File: Theory D&D\Concepts\Science\Vibrations.md
